//Ajout du champ university en plus dans la base de donnée en fonction du sous domaine. 
  ...
  const handleSubmit = async (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      try {
        ...
        navigate('/onboarding/choose-role', { state: { uid: user.uid, firstName: firstName } });
      } catch (error) {
    ...
    signInWithPopup(auth, provider)
      .then(async (result) => {
        ...
        login({
          ...
          name: user.displayName,
          email: user.email,
          role: "student" // student par défault
        });

        navigate('/onboarding/choose-role', { state: { uid: user.uid } });
        ...
        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3, padding: 4, outline: 0, borderRadius: 3, boxShadow: '2px 2px 12px rgba(0, 0, 0, 0.2)' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Button
              ...
              sx={{ mt: 3, mb: 2, padding: 1.5, borderRadius: 10, width: '50%' }}
            >
              Get Started
            </Button>
          </Box>
  ...
  const handleSubmit = async (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      try {
        ...
        const onboardingUrl = courseId ? `/onboarding/choose-role/${courseId}` : '/onboarding/choose-role';
...
//AJOUT DES FONCTIONNALITÉS AVANCÉS DE REDIRECTION EN FONCTION DE LA NATURE DE L'URL
...
//Ajout de la pop-up pour informer
  ...
  return (
    <Container component="main" maxWidth="sm">
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Already an account?</DialogTitle>
        <DialogContent>
          <DialogContentText>
            If you have already an account, sign-in to add your new course, otherwise create an account.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
            onClick={handleClose}
            variant="contained"
            sx={{ backgroundColor: '#FCE2E1', color: '#F04261', textTransform: 'none' }}
          >
            Create an account
          </Button>
          <Button
            ...
            variant="contained"
            sx={{ backgroundColor: '#DDFCE5', color: '#43AE58', textTransform: 'none' }}
          >
            Sign-in
          </Button>
        </DialogActions>
...
//ajout des modifications de design de la pop-up : 
  ...
  return (
    <Container component="main" maxWidth="sm">
      ...
      <Dialog
        open={open}
        onClose={handleClose}
        PaperProps={{ style: { borderRadius: 12, padding: '20px' } }}
      >
        <DialogTitle>Already an account?</DialogTitle>
        <DialogContent>
      ...
      >
        ...
        <DialogActions sx={{ paddingBottom: 2, paddingRight: 2 }}>
          <Button
            onClick={handleClose}
            variant="contained"
            sx={{ backgroundColor: '#FCE2E1', color: '#F04261', textTransform: 'none', borderRadius: '8px', justifyContent: 'flex-start' }}
          >
            Create an account
          </Button>
          <Button
  ...
  return (
    <Container component="main" maxWidth="sm">
      ...
      >
        ...
        <DialogActions sx={{ paddingBottom: 2, paddingRight: 2, paddingLeft: 2 }}>
          <Button
            onClick={handleClose}
            variant="contained"
            sx={{ backgroundColor: '#FCE2E1', color: '#F04261', textTransform: 'none', borderRadius: '8px', justifyContent: 'flex-start' }}
